...
function createDogListItem(dog){
    ...
    const dogContainer = document.querySelector(".main");   // selecting the main class
  
    li.className = "dogs-list__button"; // naming the class 
    li.innerText = dog.name; // takes the dog name from the object
    ...
    //from the dogContainer
        ...
        li.addEventListener ('click', () =>{
            ...
            if (typeof(element) == 'undefined' && element == null) {
                console.log("creating a Card with dogs")
                dogContainer.append(card)
            } 

            if (typeof(element) != 'undefined' && element != null) {
                dogContainer.remove(card)
                console.log("Gonzo")
            }
